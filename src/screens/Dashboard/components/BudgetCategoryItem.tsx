...
import { mapCategoryToStyle } from '@/screens/Dashboard/components/mapCategoryToStyle';
  ...
  return (
    <View style={styles.row}>
      ...
      <View style={styles.title}>
        ...
        <Text style={appStyles.subText}>Transactions: {transactions}</Text>
      </View>
      <View>
        <Text style={appStyles.subtitle}>${totalAmount.value}</Text>
      </View>
    </View>
  );
};
